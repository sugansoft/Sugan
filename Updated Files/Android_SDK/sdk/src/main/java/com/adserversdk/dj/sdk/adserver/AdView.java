...
import com.adserversdk.dj.sdk.mtrack.Utils;
import com.adserversdk.dj.sdk.utils.Cdlog;
import com.adserversdk.dj.sdk.utils.ConnectionDetecter;
import com.adserversdk.dj.sdk.utils.Settings;
...
public class AdView extends FrameLayout{
	...
	LayoutParams ad_container_params=null;
	...
	public void displayIABAd(AdResponse adResult){	
		...
		htmlAd.loadData(html, "text/html", "UTF-8");
		ad_container_params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
		htmlAd.setLayoutParams(ad_container_params);
		htmlAd.setClickable(true);
		htmlAd.setVerticalScrollBarEnabled(false);
		htmlAd.setHorizontalScrollBarEnabled(false);					
	...
	public void displayImageAd(AdResponse adResult){
		...
		if(mime_type.equalsIgnoreCase("image/gif")){
			...
			try{
				...
				ad_container_params = new LayoutParams(Integer.parseInt(ad_width), Integer.parseInt(ad_height));
