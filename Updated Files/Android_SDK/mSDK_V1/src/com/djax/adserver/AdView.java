...
public class AdView extends FrameLayout{
	...
	private String gender_par		= null;
	private String color_par		= null;
	private String loc_par			= null;
	private String key_par			= null;
	...
	//Targeting value custom work
	 public String getAge(){
		 return age_par;
	 }
	 public void setAge(String age_par){
	 ...
	 public void setGender(String gender_par){
		 this.gender_par = gender_par;
	 }
	 public String getColor(){
		 return color_par;
	 }
	 public void setColor(String color_par){
		 this.color_par = color_par;
	 }
	 public String getLoc(){
		 return loc_par;
	 }
	 public void setLoc(String loc_par){
	...
	public void setKeyWord(String key_par){
		this.key_par = key_par;
	}
	...
	public void displayHTMLAd(AdResponse adResult){	
		...
		WebView web = new WebView(adViewContext);
		...
		if(Build.VERSION.SDK_INT>=21)
		{
			...
			cook.setAcceptCookie(true);
		}
		else
		{
			CookieSyncManager syncman = null;
			syncman.getInstance().startSync();
	...
	public void displayIABAd(AdResponse adResult){	
		...
		WebView htmlAd = new WebView(adViewContext);
		//CookieManager.getInstance().setAcceptThirdPartyCookies(htmlAd,true);
		CookieManager cookieManager = CookieManager.getInstance(); 
		cookieManager.setAcceptCookie(true);
		htmlAd.setBackgroundColor(0);
		htmlAd.setPadding(0,0,0,0);
